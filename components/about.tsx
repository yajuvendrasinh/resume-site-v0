      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid items-center gap-8 mt-12 md:grid-cols-2">
          <div className="flex justify-center md:order-last">
            <div className="relative w-80 h-80 overflow-hidden rounded-full sm:w-80 sm:h-80 md:w-96 md:h-96 outline outline-primary/10 outline-offset-4 bg-neutral-200">
